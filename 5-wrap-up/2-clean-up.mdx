...
마지막 단계로 워크샵 전반에 걸쳐 사용된 리소스를 정리해 보겠습니다. 주로 S3 객체와 S3 버킷 제거에 초점을 맞출 것입니다. 이 단계들은 여러분이 개인 AWS 계정을 사용하고 있다면 매우 중요합니다. ***제거되지 않은 객체들은 계속해서 계정에 요금이 부과될 것입니다.***

S3 버킷을 삭제하지 않고 S3 객체만 삭제하는 방법:

1. [S3 dashoard ](https://console.aws.amazon.com/s3)에 로그인합니다.
2. 워크샵 과정에서 생성한 S3 버킷을 클릭합니다.
