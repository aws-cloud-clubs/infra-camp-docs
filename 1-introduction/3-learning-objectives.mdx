...
이 서비스들에 대해 잘 모르거나 AWS에 대한 지식이 부족해도 걱정하지 마세요. Hands-on 과정과 더불어, 워크샵 전반에 걸쳐 충분한 정보와 참고 자료가 제공될 예정입니다.
